...
var createWallOfShame = function(){
  var table = document.getElementById("wall-of-shame");
  ...
  var header3 = headerRow.insertCell(2);
  header1.innerHTML = "Player Name";
  header2.innerHTML = "Shame";
  header3.innerHTML = "Week";

  var body = table.appendChild(document.createElement('tbody'));

  for (var i = 0; i < wallOfShame.length; i++) {
    var row = body.insertRow();
    var cell1 = row.insertCell(0);
    var cell2 = row.insertCell(1);
    var cell3 = row.insertCell(2);
    cell1.innerHTML = wallOfShame[i].name;
    cell2.innerHTML = wallOfShame[i].shame;
    cell3.innerHTML = wallOfShame[i].week;
  }
}
